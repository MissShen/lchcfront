      ...
      <div class="table-form">
        <el-form ref="query" :model="query" label-position="right" size="small">
          <el-row :gutter="24">
            <el-col :span="3">
              <template>
                <el-select size="small" v-model="query.aaa" placeholder="订单状态">
                  <el-option label="未阅读" value="shanghai"></el-option>
                  <el-option label="已阅读" value="beijing"></el-option>
                  <el-option label="已发货" value="beijing"></el-option>
                  <el-option label="到货中" value="beijing"></el-option>
                  ...
                  <el-option label="断货" value="beijing"></el-option>
                  <el-option label="到货修改" value="beijing"></el-option>
                </el-select>
              </template>
            </el-col>
            ...
            <el-col :span="3">
              <template>
                <el-select size="small" v-model="query.bbb" placeholder="请选择">
            ...
            <el-col :span="2">
              <el-form-item>
                <el-input v-model="query.searchSenderName" placeholder=""></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="3">
              <template>
                <el-select size="small" v-model="query.ccc" placeholder="选择紧急程度">
                  <el-option label="全部" value="1"></el-option>
                  <el-option label="普通" value="2"></el-option>
                  <el-option label="部分急需" value="3"></el-option>
                  <el-option label="全部急需" value="4"></el-option>
                </el-select>
              </template>
            </el-col>
            <el-col :span="10">
              <el-form-item>
                ...
                <span>到</span>
                <span>
                      <el-date-picker type="date" size="small" placeholder="结束日期" v-model="query.endDate"></el-date-picker>
                </span>
              </el-form-item>
            </el-col>
            <el-col :span="3">
