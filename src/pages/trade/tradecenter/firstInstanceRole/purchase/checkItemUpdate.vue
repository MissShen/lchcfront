<template>
  <div>
    ...
    <div class="tabs-panel">
      <span class="active">采购单明细</span>
    </div>
    <div class="tabs-echo">
      <div class="tabs-echo-left">
        <div class="title">
          <div class="title">
            <span>采购单状态：{{this.resMainData.purchaseState}}</span>
          </div>
          <div class="tools">
      ...
      <div class="tabs-echo-right">
        <ul class="tabs-echo-ul">
          ...
          <li>拟采金额：<span>{{this.resMainData.requestTotal}}</span></li>
        </ul>
        <ul class="tabs-echo-ul">
        ...
        <el-table ref="multipleTable" :data="resData.list" tooltip-effect="dark"
          ...
          <el-table-column prop="price" label="价格" show-overflow-tooltip align="right" width="80">
            <template slot-scope="scope">
              ...
              <div class="price-ico">
                <div class="price-max">{{ scope.row.maxTradePrice }}</div>
                <div class="price-min">{{ scope.row.minTradePrice }}</div>
              </div>
            </template>
          </el-table-column>
