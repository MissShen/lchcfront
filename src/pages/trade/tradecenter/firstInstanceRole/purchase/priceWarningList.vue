      ...
      <div class="table-form">
        <el-form ref="query" :model="query" label-position="right" size="small">
          <div class="formrow">
            ...
            <span>
              <el-input v-model="query.orgName3" placeholder="生产企业" size="small"></el-input>
            </span>
            <span>
...
<script>
  ...
  // 引入用户相关请求
  import {firstPriceWarning} from 'src/axios/trade/purchase/purchase'
  ...
  export default {
    ...
    methods: {
      ...
      //  获取用户分页列表
      list () {
        firstPriceWarning(this.resData, this.query).then(res => {
