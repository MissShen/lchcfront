    ...
    <div class="tablebox">
      ...
      <div class="tableset">
        ...
        <el-table ref="multipleTable" :data="tableData3" tooltip-effect="dark"
          ...
          <el-table-column prop="purchaseCode" label="采购计划单号"></el-table-column>
          <el-table-column prop="byName" label="采购计划名称"></el-table-column>
          <el-table-column prop="createDate" label="创建时间"></el-table-column>
          <el-table-column prop="buyerName" label="买方机构"></el-table-column>
          <el-table-column prop="requestTotal" label="拟采购金额（元）"></el-table-column>
