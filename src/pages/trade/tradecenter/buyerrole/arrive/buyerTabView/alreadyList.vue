  ...
  <div>
    <div class="tabs-echo">
      <div class="tabs-echo-left">
        ...
        <div class="tools">
          <el-button size="small" class="el-button-pale">返回</el-button>
        </div>
      </div>
    ...
    <div class="tablebox">
      ...
      <div class="tableset">
        <el-table :data="resData.aaa" style="width: 100%" border>
          <el-table-column prop="drugDetail" label="到货日期" width="300">
            <template slot-scope="scope" class="drugMessage">
              <p>{{ scope.row.drugDetail }}</p>
              <p class="drugCon">{{ scope.row.drugContent}}</p>
            </template>
          </el-table-column>
          <el-table-column prop="price" label="药品信息"></el-table-column>
          <el-table-column prop="order" label="单价"></el-table-column>
          <el-table-column prop="deliver" label="订购量"></el-table-column>
          <el-table-column prop="advice" label="总到货量"></el-table-column>
          <el-table-column prop="state" label="批号"></el-table-column>
          <el-table-column prop="operate" label="有效期"></el-table-column>
