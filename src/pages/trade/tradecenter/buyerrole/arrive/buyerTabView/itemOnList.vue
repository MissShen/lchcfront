    ...
    <div class="tablebox">
      ...
      <div class="tableset">
        <el-table :data="resData.aaa" style="width: 100%" border>
          ...
          <el-table-column prop="advice" label="批号"></el-table-column>
          <el-table-column prop="advice" label="有效期"></el-table-column>
          <el-table-column prop="advice" label="销售发票号"></el-table-column>
          <el-table-column prop="advice" label="采购发票号"></el-table-column>
          <el-table-column prop="advice" label="到货量"></el-table-column>
