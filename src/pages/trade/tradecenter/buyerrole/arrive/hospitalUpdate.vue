      ...
      <div class="table-form">
        <el-form ref="query" :model="query" label-position="right" size="small">
          <el-row :gutter="24">
            <el-col :span="2">
              <template>
                  <el-select size="small" v-model="query.aaa" placeholder="请选择">
                    <el-option label="药库" value="shanghai"></el-option>
                    <el-option label="材料库" value="beijing"></el-option>
                  </el-select>
              </template>
            </el-col>
            <el-col :span="3">
              <template>
                <el-select size="small" v-model="query.bbb" placeholder="订单状态">
                  <el-option label="到货中" value="shanghai"></el-option>
            ...
            <el-col :span="3">
              <el-form-item>
                <el-input v-model="query.searchSenderName" size="small" placeholder="配送企业"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="3">
              <el-form-item>
                <el-input v-model="query.searchSenderName" size="small" placeholder="订单号"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="10">
              <el-form-item>
                <span>
                      <el-date-picker type="date" placeholder="开始日期" v-model="query.beginDate"></el-date-picker>
                </span>
                <span>到</span>
                <span>
