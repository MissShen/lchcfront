    ...
    <div class="tablebox">
      ...
      <div class="tableset">
        ...
        >
          ...
          <el-table-column label="状态" width="100" prop="e.code" sortable="custom" align="center" >
            <template slot-scope="scope">
              {{ scope.row.stateName }}
            </template>
          </el-table-column>
          <el-table-column label="操作" width="150">
            <template slot-scope="scope">
              <div class="operates">
               ...
               <a @click="toHandle(scope.row.id,scope.row.orderItemId)" title="处理" class="operation-btn" size="small">处理</a>
              </div>
            </template>
          </el-table-column>
        </el-table>
      ...
      <div class="foot-btn">
        <div class="foot-left">
          <el-button type="primary" size="small" @click="reasonManage()">
            投诉原因管理
          </el-button>
        </div>
      </div>
...
<script>
  ...
  // 引入用户相关请求
  import {queryWaitHandleList} from 'src/axios/trade/evaluate/evaluate'
  ...
  export default {
    ...
    methods: {
      ...
      list () {
        ...
        queryWaitHandleList(this.resData, this.query).then(res => {
