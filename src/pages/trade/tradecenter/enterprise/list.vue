<template>
  ...
  <div class="tablebox">
    ...
    <el-form ref="query" :model="query" label-position="right" size="small" :inline="true" class="table-form">
      <el-form-item>
        <el-input v-model="query.searchKeyWord" @keyup.enter.native="searchEnterFun" placeholder="企业名称"
                  size="small"></el-input>
      </el-form-item>
      <el-form-item>
...
<script>
  ...
  // 引入用户相关请求
  import {getCatEnterpriseList} from 'src/axios/trade/enterprise/enterprise'
  ...
  export default {
    ...
    methods: {
      ...
      list() {
        ...
        getCatEnterpriseList(this.resData, this.query).then(res => {
