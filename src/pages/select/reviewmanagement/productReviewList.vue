    ...
    <div class="tablebox">
      ...
      <div class="table-form">
        <el-form ref="query" :model="query" size="small" :inline="true" class="demo-form-inline">
          ...
          <el-form-item>
            <el-input v-model="query.name" placeholder="药品通用名"></el-input>
          </el-form-item>
          <el-form-item>
            <el-input v-model="query.name" placeholder="合并剂型"></el-input>
          </el-form-item>
          <el-form-item>
            <el-input v-model="query.name" placeholder="合并规格"></el-input>
          </el-form-item>
          <el-form-item>
      ...
      <div class="tableset">
        <el-table
          ...
          <el-table-column label="合并规格">
            <template slot-scope="scope">
              <span>{{ scope.row.expertName }}</span>
            </template>
          </el-table-column>
          <el-table-column label="第1层次(中标/产品数)">
            <template slot-scope="scope">
              <span>{{ scope.row.expertName }}</span>
            </template>
          </el-table-column>
          <el-table-column label="主要规格(中标/产品数)">
            <template slot-scope="scope">
              <span>{{ scope.row.expertName }}</span>
            </template>
          </el-table-column>
          <el-table-column label="查看产品">
            <template slot-scope="scope">
              <span>{{ scope.row.expertName }}</span>
            </template>
          </el-table-column>
