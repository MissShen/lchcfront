...
<script>
  ...
  // 引入用户相关请求  引自js文件
  import {selectScoreProductList} from 'src/axios/select/scoremanagement/scoreProduct'
  ...
  export default {
    ...
    methods: {
      ...
      //  获取用户分页列表
      list () {
        selectScoreProductList(this.resData, this.query).then(res => {
          console.log(res);
