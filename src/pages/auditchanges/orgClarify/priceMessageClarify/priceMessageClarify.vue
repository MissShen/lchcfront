<template>
  <el-dialog
    custom-class="w80"
    :title="this.showForm[0].SHOWFLAG?'价格申报澄清详情':'价格申报澄清'"
    ...
    <div v-if="visible">
      <div class="main audit-main">
        <ul class="side side-init" id="product-declare-audit-side">
          <li v-for="(item,index) in nodesPosition" :key="index"><a @click="changeScrollHeight(item.nodePosition,'product-declare-audit-box','jump-pro-dec-audit',index)" class="d_jump jump-pro-dec-audit">{{item.itemName}}</a></li>
        </ul>
        ...
        <div class="right-box">
          <div class="tableset audit-info">
            <el-form id="product-declare-audit" ref="showForm" label-width="150px" size="small" label-position="left">
              ...
              <price-basics v-if="priceBasShow" :projectProductId="this.productId" :changeFlag="this.changeFlag"></price-basics>
                  ...
                  <el-col :span="24">
                    <el-row>
                      ...
                      <span class="audit-check-box">
                        <a class="audit-answer-if" v-if="flagForm[0].PRICETYPE" type="warning" @click="findQueryInfo('PRICETYPE',flagForm[0].ID)">{{flagForm[0].PRICETYPE=='0'?'已澄清':'未澄清'}}</a>
                    </span>
                      </el-col>
                    </el-row>
                  </el-col>
                ...
                <el-row class="audit-item-box" v-if="showForm[0].PRICETYPE != '2'">
                  ...
                  <el-col :span="12">
                    <el-row>
                      ...
                      <el-col :span="24">
                      <span class="audit-check-box">
                          <a class="audit-answer-if" v-if="flagForm[0].PROVINCE" type="warning" @click="findQueryInfo('PROVINCE',flagForm[0].ID)">{{flagForm[0].PROVINCE=='0'?'已澄清':'未澄清'}}</a>
                      </span>
                      </el-col>
                    </el-row>
                  </el-col>
                ...
                <el-row class="audit-item-box">
                  <el-col :span="12" v-if="showForm[0].PRICETYPE !='2'">
                    <el-row>
                      ...
                      <el-col :span="24">
                      <span class="audit-check-box">
                          <a class="audit-answer-if" v-if="flagForm[0].PROJECTNAME" type="warning" @click="findQueryInfo('PROJECTNAME',flagForm[0].ID)">{{flagForm[0].PROJECTNAME=='0'?'已澄清':'未澄清'}}</a>
                      </span>
                      </el-col>
                    </el-row>
                  </el-col>
                  <el-col :span="12" v-if="showForm[0].PRICETYPE =='0'">
                    <el-row>
                      ...
                      <el-col :span="24">
                     <span class="audit-check-box">
                          <a class="audit-answer-if" v-if="flagForm[0].PRICE" type="warning" @click="findQueryInfo('PRICE',flagForm[0].ID)">{{flagForm[0].PRICE=='0'?'已澄清':'未澄清'}}</a>
                      </span>
                      </el-col>
                    </el-row>
                  </el-col>
                  <el-col :span="12" v-if="showForm[0].PRICETYPE =='1'">
                    <el-row>
                      ...
                      <el-col :span="24">
                      <span class="audit-check-box">
                          <a class="audit-answer-if" v-if="flagForm[0].REPRESENTATIVESPEC" type="warning" @click="findQueryInfo('REPRESENTATIVESPEC',flagForm[0].ID)">{{flagForm[0].REPRESENTATIVESPEC=='0'?'已澄清':'未澄清'}}</a>
                      </span>
                      </el-col>
                    </el-row>
                  </el-col>
                ...
                <el-row class="audit-item-box">
                  <el-col :span="24" v-if="showForm[0].PRICETYPE == '0'">
                    <el-row>
                      ...
                      <el-col :span="12">
                     <span class="audit-check-box">
                          <a class="audit-answer-if" v-if="flagForm[0].EXECUTIONDATE" type="warning" @click="findQueryInfo('EXECUTIONDATE',flagForm[0].ID)">{{flagForm[0].EXECUTIONDATE=='0'?'已澄清':'未澄清'}}</a>
                      </span>
                      </el-col>
                    </el-row>
                  </el-col>
                  <el-col :span="12" v-if="showForm[0].PRICETYPE == '1'">
                    <el-row>
                      ...
                      <el-col :span="24">
                     <span class="audit-check-box">
                          <a class="audit-answer-if" v-if="flagForm[0].REPRESENTATIVEPRICE" type="warning" @click="findQueryInfo('REPRESENTATIVEPRICE',flagForm[0].ID)">{{flagForm[0].REPRESENTATIVEPRICE=='0'?'已澄清':'未澄清'}}</a>
                      </span>
                      </el-col>
                    </el-row>
                  </el-col>
                  <el-col :span="12" v-if="showForm[0].PRICETYPE == '1'">
                    <el-row>
                      ...
                      <el-col :span="24">
                     <span class="audit-check-box">
                          <a class="audit-answer-if" v-if="flagForm[0].REPRESENTATIVEPACKAGING" type="warning" @click="findQueryInfo('REPRESENTATIVEPACKAGING',flagForm[0].ID)">{{flagForm[0].REPRESENTATIVEPACKAGING=='0'?'已澄清':'未澄清'}}</a>
                      </span>
                      </el-col>
                    </el-row>
                  </el-col>
                ...
                <el-row class="audit-item-box" v-if="showForm[0].PRICETYPE=='1'">
                    ...
                    <el-row>
                      <el-col :span="12">
                        <el-row>
                          ...
                          <el-col :span="24">
                         <span class="audit-check-box">
                          <a class="audit-answer-if" v-if="flagForm[0].METHOD" type="warning" @click="findQueryInfo('METHOD',flagForm[0].ID)">{{flagForm[0].METHOD=='0'?'已澄清':'未澄清'}}</a>
                      </span>
                          </el-col>
                        </el-row>
                      </el-col>
                  ...
                  <el-col :span="12">
                    <el-row>
                      ...
                      <el-col :span="24">
                     <span class="audit-check-box">
                          <a class="audit-answer-if" v-if="flagForm[0].CALCULATEPRICE" type="warning" @click="findQueryInfo('CALCULATEPRICE',flagForm[0].ID)">{{flagForm[0].CALCULATEPRICE=='0'?'已澄清':'未澄清'}}</a>
                      </span>
                      </el-col>
                    </el-row>
                  </el-col>
                ...
                <el-row class="audit-item-box" v-if="showForm[0].PRICETYPE=='1'">
                  <el-col :span="24">
                    <el-row>
                      ...
                      <el-col :span="24">
                     <span class="audit-check-box">
                          <a class="audit-answer-if" v-if="flagForm[0].REMARK" type="warning" @click="findQueryInfo('REMARK',flagForm[0].ID)">{{flagForm[0].REMARK=='0'?'已澄清':'未澄清'}}</a>
                      </span>
                      </el-col>
                    </el-row>
                  </el-col>
                  ...
                  <el-col :span="24">
                    <el-row>
                      <el-col :span="24">
                        ...
                        <el-col :span="24">
                     <span class="audit-check-box">
                          <a class="audit-answer-if" v-if="flagForm[0].DISCOUNTPRICE" type="warning" @click="findQueryInfo('DISCOUNTPRICE',flagForm[0].ID)">{{flagForm[0].DISCOUNTPRICE=='0'?'已澄清':'未澄清'}}</a>
                      </span>
                        </el-col>
                      </el-col>
                    </el-row>
                ...
                <el-row :gutter="2" v-for="(item,index) in showForm" :key="index">
                  ...
                  <el-col :span="6">
                    <el-row>
                      <el-col :span="24">
                      <el-form-item class="audit-form-item" label="项目名称：">
                        <span>{{item.PROJECTNAME}}</span>                      </el-form-item>
                      <el-col :span="24">
                        <span class="audit-check-box">
                          <a class="audit-answer-if" v-if="flagForm[index].PROJECTNAME" type="warning" @click="findQueryInfo('PROJECTNAME',flagForm[index].ID)">{{flagForm[index].PROJECTNAME=='0'?'已澄清':'未澄清'}}</a>
                        </span>
                      </el-col>
                      </el-col>
                    </el-row>
                  ...
                  <el-col :span="6">
                    <el-row>
                      <el-col :span="24">
                        <el-form-item class="audit-form-item" label="中标价：">
                          <span>{{item.PRICE}}</span>                      </el-form-item>
                        <el-col :span="24">
                        <span class="audit-check-box">
                          <a class="audit-answer-if" v-if="flagForm[index].PRICE" type="warning" @click="findQueryInfo('PRICE',flagForm[index].ID)">{{flagForm[index].PRICE=='0'?'已澄清':'未澄清'}}</a>
                        </span>
                        </el-col>
                      </el-col>
                    </el-row>
                  ...
                  <el-col :span="6">
                    <el-row>
                      <el-col :span="24">
                        <el-form-item class="audit-form-item" label="执行日期：">
                          <span>{{item.EXECUTIONDATE}}</span>                      </el-form-item>
                        <el-col :span="24">
                        <span class="audit-check-box">
                          <a class="audit-answer-if" v-if="flagForm[index].EXECUTIONDATE" type="warning" @click="findQueryInfo('EXECUTIONDATE',flagForm[index].ID)">{{flagForm[index].EXECUTIONDATE=='0'?'已澄清':'未澄清'}}</a>
                        </span>
                        </el-col>
                      </el-col>
                    </el-row>
...
<script>
  ...
  import {selectQueryFieldById} from 'src/axios/auditchanges/messageClarify/price'
...
//          }
        ...
        await selectQueryFieldById(id).then(res => {
