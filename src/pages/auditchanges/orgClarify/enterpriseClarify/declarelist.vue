      ...
      <div class="tableset">
        <el-table
          ...
          <el-table-column label="操作" width="80">
            <template slot-scope="scope">
              <div class="operates">
                <span><a href="javascript:void(0);" class="operation-btn" @click="handleGoAudit(scope.row.ID)">详情</a></span>
              </div>
            </template>
          </el-table-column>
        </el-table>
...
<script>
  ...
  // 引入用户相关请求
  import { declareList, declare, doubt, clarify } from 'src/axios/auditchanges/messageClarify/enterprise'
  import { decodeQuestion } from 'src/axios/auditchanges/common/nestedJson'
  // import {keyBoardEnter} from "src/utils";
  import info from 'src/pages/auditchanges/common/enterprise/info'
  import Vue from 'vue'

  import changeList from 'src/pages/auditchanges/orgClarify/enterpriseClarify/changelist'
