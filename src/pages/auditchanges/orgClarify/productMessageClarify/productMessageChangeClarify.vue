<template>
  ...
  <div class="tab-box">
    <!--<div class="tabs-panel">
      <router-link to="/AUDIT/orgClarify/productMessageDeclareClarify">产品申报澄清</router-link>
      <span class="active">产品变更澄清</span>
    </div>-->
   ...
   <!-- <el-tabs v-model="activeName" @tab-click="toDeclare">
    ...
    <div class="tableset">
      <el-table
       ...
       <!-- <el-table-column label="产品名称">
        ...
        <el-table-column label="澄清记录" show-overflow-tooltip>
          <template slot-scope="scope">
          ...
          <template slot-scope="scope">
            <div class="operates">
              <span>
                ...
                <a
                  class="operation-btn"
                  @click="handleGoClarify(scope.row.ID,scope.row.UPPRODUCTID)">澄清</a>
              </span>
              <!--<span>-->
                <!--<a class="operation-btn" v-if="scope.row.QUESTIONCOUNT == scope.row.TALKCOUNT" @click="handleGoClarify(scope.row.ID,scope.row.UPPRODUCTID)">详情</a>-->
              <!--</span>-->
            </div>
          </template>
        </el-table-column>
    ...
    <change-clarify ref="changeClarify"></change-clarify>
  </div>
    </div>
  </div>
</template>
...
<script>
  import { queryListChange} from 'src/axios/auditchanges/messageClarify/productClarify'
  // import {keyBoardEnter} from "src/utils";
  import changeClarify from "./changeClarify";
  export default {
    components:{
      changeClarify
    },
    ...
    methods: {
      ...
      handleGoClarify(id,upProductId){
        this.$nextTick(() => {
          this.$refs.changeClarify.list(id,upProductId)
        })
      },
      // ************************
