...
<script>
  ...
  // 引入tab的页面组件
  import queuingDeclareTable from 'src/pages/auditchanges/auditManage/orgDeclareConfig/queuingDeclareTable'
  import notDeclareTable from 'src/pages/auditchanges/auditManage/orgDeclareConfig/notDeclareTable'
