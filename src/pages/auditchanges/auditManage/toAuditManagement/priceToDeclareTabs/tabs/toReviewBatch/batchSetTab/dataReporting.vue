...
<template>
  ...
  <div class="tablebox">
    ...
    <!--按钮-->
      <div class="foot-btn">
        <div class="foot-left">
          <el-button v-on:click="addPriceBatch" type="primary" size="small">移入本批次</el-button>
        </div>
      </div>
...
<script>
  //引入列表数据
  import {priceToDeclareBatchAdd,addPriceToDeclareBatch} from 'src/axios/auditchanges/toAuditManagement/priceToDeclareTabs'
  ...
  export default {
    ...
    methods: {
      ...
      select() {
        ...
        priceToDeclareBatchAdd(this.resData,this.query).then(res=>{
      ...
      addPriceBatch(){//移入本批次
        ...
        addPriceToDeclareBatch(paramsForm).then((res)=>{
