...
<script>
  // import {enterprisesToDeclareList} from 'src/axios/auditchanges/toAuditManagement/priceToDeclareTabs'
  import {removeBatch,reomveAudit} from 'src/axios/auditchanges/toAuditManagement/productDeclarationTabs'
  import {priceToDeclareBatchList} from 'src/axios/auditchanges/toAuditManagement/priceToDeclareTabs'
  ...
  export default {
    ...
    methods: {
      ...
      list() {
        ...
        priceToDeclareBatchList(this.paramsForm).then(res => {
          console.log(res,'价格申报批次审核')
          if(res.data.success){
