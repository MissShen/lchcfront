<template>
  <div>
    ...
    <div class=" padding10">
      <!-- ========================== 主内容start ========================= -->
      <el-tabs type="border-card" v-model="activeName" @tab-click="handleClick"  width="100%">
        <el-tab-pane label="一审" name="1" v-if="auditorSize>=1" >
          ...
          <distribution-of-the-auditor @userData="userData" :allData="allData" :projectId="projectId" :activeName="activeName" v-if="activeName=='1'"></distribution-of-the-auditor>
        </el-tab-pane>
        <el-tab-pane label="二审" name="2" v-if="auditorSize>=2">
          ...
          <distribution-of-the-auditor @userData="userData" :allData="allData" :projectId="projectId" :activeName="activeName" v-if="activeName=='2'"></distribution-of-the-auditor>
        </el-tab-pane>
        <el-tab-pane label="三审" name="3"  v-if="auditorSize>=3">
          ...
          <distribution-of-the-auditor @userData="userData" :allData="allData" :projectId="projectId" :activeName="activeName" v-if="activeName=='3'"></distribution-of-the-auditor>
        </el-tab-pane>
        <el-tab-pane label="四审" name="4" v-if="auditorSize>=4">
          ...
          <distribution-of-the-auditor @userData="userData" :allData="allData" :projectId="projectId" :activeName="activeName" v-if="activeName=='4'"></distribution-of-the-auditor>
        </el-tab-pane>
        <el-tab-pane label="五审" name="5" v-if="auditorSize>=5" >
          ...
          <distribution-of-the-auditor @userData="userData" :allData="allData" :projectId="projectId" :activeName="activeName" v-if="activeName=='5'"></distribution-of-the-auditor>
        </el-tab-pane>
      </el-tabs>
