...
<script>
  //引入列表数据
  import {priceChangeBatchAdd,addPriceChangeBatch} from 'src/axios/auditchanges/toAuditManagement/priceChangeTabs'
  ...
  export default {
    ...
    methods: {
      ...
      list() {
        ...
        priceChangeBatchAdd(this.resData,this.query).then(res=>{
