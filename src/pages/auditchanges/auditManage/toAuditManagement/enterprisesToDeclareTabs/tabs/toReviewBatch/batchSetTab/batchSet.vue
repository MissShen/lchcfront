...
<script>
  ...
  import {enterprisesToDeclareBatchList} from 'src/axios/auditchanges/toAuditManagement/enterprisesToDeclareTabs'
  ...
  export default {
    ...
    methods: {
      ...
      select() {
        ...
        enterprisesToDeclareBatchList(this.paramsForm).then(res => {
          // console.log(res,'res')
          if(res.success){
      ...
      reomveAuditMan(count){//删除审核员
        ...
        console.log(this.projectUserIdMap,'this.projectUserIdMap');
