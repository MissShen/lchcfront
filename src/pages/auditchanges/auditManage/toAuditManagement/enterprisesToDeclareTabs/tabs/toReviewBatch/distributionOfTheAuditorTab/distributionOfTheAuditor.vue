...
<script>
  ...
  import {enterprisesToDeclareAuditorList} from 'src/axios/auditchanges/toAuditManagement/enterprisesToDeclareTabs'
  ...
  export default {
    ...
    methods: {
      //条件查询
      select() {
        enterprisesToDeclareAuditorList(this.projectId,this.activeName).then(res=>{
