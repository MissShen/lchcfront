<template>
  ...
  <div class="tablebox">
    <el-tabs v-model="activeName" @tab-click="handleClick">
      ...
      <div class="table-form">
        <el-form ref="query" :model="query" label-position="right" size="small">
          <el-row :gutter="24">
            <el-col :span="3">
              <el-form-item>
                <el-input v-model="query.Id" placeholder="申请企业名称"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="3">
              <el-form-item>
                <el-input v-model="query.Id" placeholder="组织机构代码"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="3">
              <el-form-item>
                <el-input v-model="query.Id" placeholder="社会统一信用代码"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="7">
              <el-form-item>
            ...
            <el-col :span="6">
              <el-form-item>
                <el-button v-on:click="select" type="warning" plain>查询</el-button>
                <el-button v-on:click="remove" type="primary" plain>重置</el-button>
              </el-form-item>
            </el-col>
          </el-row>
        </el-form>
      ...
      <!--<div>-->
        <!--<el-button v-on:click="select" type="primary" plain>选择创建批次</el-button>-->
        <!--<el-button v-on:click="remove" type="primary" plain>全部创建批次</el-button>-->
      <!--</div>-->
      ...
      <div>
        <!--按钮-->
        <el-button v-on:click="select" type="primary" plain>移除本批次</el-button>
        <el-button v-on:click="select" type="primary" plain>删除一审人员</el-button>
        <el-button v-on:click="select" type="primary" plain>删除二审人员</el-button>
        N审省略等待业务完善
        <!--按钮-->
      </div>
      <!-- 表格分页 -->
