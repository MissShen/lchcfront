<template>
  ...
  <div class="tablebox">
    <el-tabs v-model="activeName" @tab-click="handleClick">
      <div><el-button v-on:click="select" type="primary" plain>返回</el-button></div>
      ...
      <div>
        <span>
已分配总数量： 0 未分配数量：100 分配数量输入总和不能大于未分配数量，否则不能保存
        </span>
        <!--按钮-->
        <el-button @click="handleGoEdit()" type="primary" plain>新增审核员</el-button>
      ...
      <div>
        <!--按钮-->
        <el-button v-on:click="" type="primary" plain>保持</el-button>
