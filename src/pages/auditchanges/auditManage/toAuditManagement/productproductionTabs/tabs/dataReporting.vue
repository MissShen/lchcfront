      ...
      <div class="table-form">
        <el-form ref="query" :model="query" label-position="right" size="small">
          <el-row :gutter="24">
            <el-col :span="3">
              <el-form-item>
                <el-input v-model="query.Id" placeholder="申请单号"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="4">
              <el-form-item>
                <el-select v-model="query.UpTypeId" placeholder="全部">
                  <el-option
            ...
            <el-col :span="3">
              <el-form-item>
                <el-input v-model="query.Id" placeholder="企业名称"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="3">
              <el-form-item>
                <el-input v-model="query.Id" placeholder="转出企业名称"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="6">
              <el-form-item>
