...
<script>
  //引入列表数据
  import {enterpriseChangeBatchAdd,enterpriseChangeInsert,enterpriseChangeCount,enterpriseChangeInsertAll} from 'src/axios/auditchanges/toAuditManagement/enterpriseChangeTabs'
...
//      this.select()
    ...
    methods: {
      ...
      select() {
        ...
        enterpriseChangeBatchAdd(resData,selectQuery).then(res=>{
      ...
      selectCreatedBatch(selectedDataId){//选择创建批次
        ...
        enterpriseChangeInsert(idForm).then(res=>{
          // console.log(res,'res......')
          if(res.success){
            this.$message({
              message:'成功',
      ...
      allBatch(){//全选创建批次
        enterpriseChangeCount().then(res=>{
          // console.log(res,'res......')
          if(res.success){
      ...
      allCreatedBatch(){//全选创建批次
        enterpriseChangeInsertAll().then(res=>{
          // console.log(res,'res......')
          if(res.success){
            this.$message({
              message:'保存成功',
