...
<template>
  ...
  <div class="tablebox">
    ...
    <!--按钮-->
      <div class="foot-btn">
        <div class="foot-left">
          <el-button v-on:click="addEnterprisesChange" type="primary" size="small">移入本批次</el-button>
        </div>
      </div>
...
<script>
  //引入列表数据
  import {enterpriseChangeBatchAdd,addEnterprisesChangeBatch} from 'src/axios/auditchanges/toAuditManagement/enterpriseChangeTabs'
  ...
  export default {
    ...
    methods: {
      ...
      select() {
        ...
        enterpriseChangeBatchAdd(this.resData,this.query).then(res=>{
