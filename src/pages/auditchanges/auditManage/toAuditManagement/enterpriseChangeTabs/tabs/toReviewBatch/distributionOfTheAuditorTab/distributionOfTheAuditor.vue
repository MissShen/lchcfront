...
<script>
  ...
  import {enterprisesChangeAuditorList} from 'src/axios/auditchanges/toAuditManagement/enterpriseChangeTabs'
  ...
  export default {
    ...
    methods: {
      //条件查询
      select() {
        enterprisesChangeAuditorList(this.projectId,this.activeName).then(res=>{
