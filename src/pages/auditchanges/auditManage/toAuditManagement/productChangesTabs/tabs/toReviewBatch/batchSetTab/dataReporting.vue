...
&nbsp;至&nbsp;
      ...
      <div class="foot-btn">
        <div class="foot-left">
          <!--按钮-->
          <el-button v-on:click="addProductChange" type="primary" size="small">移入本批次</el-button>
          <!--按钮-->
        </div>
      </div>
...
<script>
  import {productChangeBatchAdd,addProductChangeBatch} from 'src/axios/auditchanges/toAuditManagement/productChangesTabs'
