...
<script>
  import {priceChangeAuditorList} from 'src/axios/auditchanges/toAuditManagement/productTransferTabs'
  ...
  export default {
    ...
    methods: {
      //条件查询
      select() {
        priceChangeAuditorList(this.projectId,this.activeName).then(res=>{
