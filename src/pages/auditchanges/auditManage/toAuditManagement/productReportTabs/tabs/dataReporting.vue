  ...
  <div >
    <div class="tableset">
      <el-table
        ...
        <el-table-column label="已分配数量" prop="userCount" header-align="center" align="right">
          <template slot-scope="scope">
    ...
    <el-dialog
      top="2vh" :visible.sync="showForm" :before-close="handleClose" width="50%" :append-to-body="true">
      <div>
        <span>审核员</span>
        <div>
...
<script>
  ...
  import {reportProductAuditorList,addAuditor} from 'src/axios/auditchanges/toAuditManagement/productReportTabs'
  ...
  export default {
    ...
    //初始化函数
    created() {
      console.log(this.selectedDataReport,'selectedDataReport')
    ...
    methods: {
      //条件查询
      select() {
        reportProductAuditorList(this.dataType).then(res=>{
