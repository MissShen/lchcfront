...
<!--
      ...
      <div class="foot-btn">
        <div class="foot-left">
          <el-button v-on:click="addProductBatch" type="primary" size="small">移入本批次</el-button>
        </div>
      </div>
...
<script>
  //引入列表数据
  import {productDeclarationBatchAdd,addProductToDeclareBatch} from 'src/axios/auditchanges/toAuditManagement/productDeclarationTabs'
  ...
  export default {
    ...
    methods: {
      ...
      select() {
        ...
        productDeclarationBatchAdd(this.resData,this.query).then(res=>{
