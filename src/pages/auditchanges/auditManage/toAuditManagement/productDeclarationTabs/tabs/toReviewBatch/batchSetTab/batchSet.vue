    ...
    <!-- 表格查询表单 -->
      <el-form ref="query" :model="query" label-position="right" size="small" :inline="true" class="table-form">
          ...
          <el-form-item>
                ...
                <el-date-picker  v-model="query.beginDate" size="small" type="datetime" placeholder="申报开始日期"></el-date-picker>
              &nbsp;至&nbsp;
                <el-date-picker  v-model="query.endDate" size="small" type="datetime" placeholder="申报结束日期"></el-date-picker>
...
<script>
  import {productDeclarationBatchList,removeBatch,reomveAudit} from 'src/axios/auditchanges/toAuditManagement/productDeclarationTabs'
    ...
    methods: {
      ...
      select() {
        ...
        this.paramsForm = {
          ...
          dosageForm:this.query.dosageForm,
          spec:this.query.spec,
          beginDate:this.query.beginDate,
          endDate:this.query.endDate,
        };
        productDeclarationBatchList(this.paramsForm).then(res => {
