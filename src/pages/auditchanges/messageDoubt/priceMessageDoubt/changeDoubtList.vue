    ...
    <div class="tableset">
      <el-table
       ...
       <!-- <el-table-column label="产品名称">
        ...
        <el-table-column align="right" header-align="left" label="转换比" width="60px">
          <template slot-scope="scope">
        ...
        <el-table-column label="操作" width="80px">
          <template slot-scope="scope">
            <div class="operates">
              <a href="javascript:;" @click="handleGoClarify(scope.row.ID,scope.row.QTID,scope.row.UPPRODUCTID)">详情</a>
            </div>
          </template>
        </el-table-column>
      </el-table>
...
<script>
  import {queryListChange} from 'src/axios/auditchanges/messageDoubt/priceDoubt'
