            ...
            <el-row :gutter="24">
                <el-col :span="12">
                  <el-form-item label="产品名称">
                    ...
                    <a class="audit-answer-if" @click="findProductMessage(id)">查看产品信息</a>
                  </el-form-item>
                </el-col>
              <el-col :span="12">
            ...
            <el-row :gutter="24">
              <el-col :span="24">
                <el-form-item label="澄清时间">
                  <span>{{dataForm.CLARIFYDATE}}</span>
                </el-form-item>
              </el-col>
            </el-row>
            ...
            <el-row :gutter="24">
              <el-col :span="24">
                <el-form-item label="澄清内容" prop="content">
                  <span>{{dataForm.CLARIFYEXPLAN}}</span>
                </el-form-item>
              </el-col>
            </el-row>
            ...
            <el-row :gutter="24">
              <el-col :span="24">
                <el-form-item label="澄清附件">
                  <images-preview ref="imagesPreview" :imgIdListUnUnique="dataForm.FILEID"
                                  :operate="false"></images-preview>
                </el-form-item>
              </el-col>
            </el-row>
            ...
            <el-row :gutter="24">
              <el-col :span="24">
                <el-form-item label="举报是否有效">
                    <el-radio-group v-model="dataForm.STATESAUDIT">
