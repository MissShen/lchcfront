    ...
    <div class="table-form">
      <el-form ref="query" :model="query" label-position="right" size="small">
        <el-row :gutter="24">
          <el-col :span="6">
            <el-form-item>
              <el-input v-model="query.name" placeholder="申请企业名称"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="6">
            <el-form-item>
              <el-input v-model="query.name" placeholder="转出企业名称"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="6">
            <el-form-item>
    ...
    <div class="tableset">
      <el-table
        ...
        <el-table-column label="操作">
          <template slot-scope="scope">
            <el-button @click="handleGoRole(scope.row.code)" type="text" size="small">查看</el-button>
            <el-button @click="handleGoEdit(scope.row.userName)" type="text" size="small">修改</el-button>
