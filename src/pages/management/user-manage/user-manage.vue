            ...
            <template slot-scope="scope">
              <el-tooltip placement="top">
                <div slot="content" style="text-align: center;">
                  <a class="el-icon-edit" @click="handleGoEdit(scope.row.userName)"
                     style="color: hotpink;">编辑</a>
                  <span class="space-bar"></span>
                  <a class="el-icon-setting" @click="handleGoRole(scope.row.code)"
                     style="color: mediumturquoise;">角色</a>
                  <span class="space-bar"></span>
                  <a class="el-icon-delete" @click="handleDelete(scope.row.id)" style="color: red;">删除</a>
                </div>
