    ...
    <div class="tablebox">
      ...
      <!-- 表格查询表单 -->
        <el-form ref="query" :model="query" :inline="true" class="table-form" onsubmit="return false;">
            <el-form-item>
              <el-input size="small" v-model="query.mechanismName" maxlength="200" placeholder="医院名称" @keyup.enter.native="searchEnterFun"></el-input>
            </el-form-item>
            <el-form-item>
      ...
      <el-dialog title="承诺书" :visible.sync="showCommitmentState" :before-close="closeForm" width="52%">
        <el-form :inline="true" ref="insertForm" :model="insertForm" class="demo-form-inline">
          ...
          <div>
            <p class="pcssd" align="right">医院机构名称：<img :src="this.insertForm.stampImage" /></p>
