<template>
  <div>
    ...
    <div class="tablebox">
      ...
      <!-- 表格查询表单 -->
        <el-form ref="query" :model="query" class="table-form" :inline="true" onsubmit="return false;">

            <el-form-item>
              <el-input size="small" v-model="query.mechanismName" maxlength="200" placeholder="企业名称" @keyup.enter.native="searchEnterFun"></el-input>
            </el-form-item>
            <el-form-item>
      ...
      <div class="tableset">
        <el-table :data="resData.list"
          ...
          <el-table-column label="签订时间" width="180" prop="SIGNEDDATE" sortable="custom">
            <template slot-scope="scope">
