...
<script>
  ...
  // 引入用户相关请求
  import {queryRelevantList, addProduct} from 'src/axios/contract/sender/hospitalSelectSender'
  ...
  export default {
    ...
    methods: {
      ...
      list () {
        ...
        queryRelevantList(this.resData, this.query, this.senderId).then(res => {
