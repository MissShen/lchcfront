<template>
  <el-dialog
    ...
    <el-form :model="query" ref="query" label-width="150px" class="table-form" label-position="left" :inline="true" size="small">
        <el-form-item>
    ...
    <div class="tableset">
      <el-table
        ...
        <el-table-column label="操作" width="60">
          <template slot-scope="scope">
            <div class="operates">
              <span><a class="operation-btn" @click="chooseOrg(scope.row)">选择</a></span>
            </div>
          </template>
        </el-table-column>
      </el-table>
...
<script>
  ...
  import {queryAllOrg} from 'src/axios/datacenter/authdata/qualitybulletin/qualityBulletin'
  ...
  export default {
    ...
    methods: {
      ...
      list(){
        queryAllOrg(this.query, this.resData).then(res => {
      ...
      chooseOrg(value) {
        this.$emit('chooseOrg', {value: value});
        this.visible = false;
      },
