          ...
          <el-row :gutter="24">
            <el-col :span="12">
              <el-form-item label="药品通用名：" required="true">
                <el-input class="width-180" placeholder="查询药品" readonly="true"></el-input>
            ...
            <el-col :span="12">
              <el-form-item label="药品剂型：" required="true">
                <el-input class="width-180" placeholder="查询剂型" readonly="true"></el-input>
          ...
          <el-row :gutter="24">
            ...
            <el-col :span="12">
              <el-form-item label="关联药品：">
               <span>已选择
                  <el-input v-model="count" class="width-180" readonly="true"></el-input>
                            种药品</span>
                <a @click="assoDrugs('CHOOSE')">选择</a>
...
<script>
  ...
  import {add} from 'src/axios/datacenter/authdata/otcdrugs/catOtc'
