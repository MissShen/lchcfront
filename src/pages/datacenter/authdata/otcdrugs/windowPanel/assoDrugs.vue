<template>
  <el-dialog
    ...
    <el-form :model="dataForm" ref="dataForm"
        ...
        <el-form-item>
          <el-select v-model="dataForm.searchType" size="small">
            ...
            <el-option label="剂型" value="2"></el-option>
    ...
    <span slot="footer">
      ...
      <el-button size="small" type="primary" @click="chooseAssDrugs" v-if="this.type === '选择'">保存</el-button>
...
<script>
  ...
  import {hasAsso} from 'src/axios/datacenter/authdata/otcdrugs/catOtc'
  import {notAsso} from 'src/axios/datacenter/authdata/otcdrugs/catOtc'
  ...
  export default {
    ...
    methods: {
      ...
      list(){
        if (this.type === '查看已关联') {
          hasAsso(this.dataForm, this.resData, this.data).then(res => {
          ...
          notAsso(this.dataForm, this.resData, this.data).then(res => {
            this.resData = res.data;
            if (this.resData.pageNum == 0) {
              this.resData.pageNum = 1
            }
