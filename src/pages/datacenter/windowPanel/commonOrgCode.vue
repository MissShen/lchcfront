    ...
    <div class="tableset">
      <el-table
        ...
        <el-table-column label="操作" width="60">
          <template slot-scope="scope">
            <div class="operates"><a class="operation-btn" @click="chooseOrgCode(scope.row)">选择</a></div>
          </template>
        </el-table-column>
      </el-table>
    </div>
...
<script>
  ...
  import {findFactoryOrg} from 'src/axios/datacenter/authdata/cnprotecteddrug/cnProtected'
  ...
  export default {
    ...
    methods: {
      ...
      list(){
        findFactoryOrg(this.query, this.resData).then(res => {
      ...
      chooseOrgCode(value) {
        this.$emit('chooseOrgCode', {value: value});
        this.visible = false;
      },
