    ...
    <div class="tableset">
      <el-table
        ...
        <el-table-column label="操作" width="60">
          <template slot-scope="scope">
            <div class="operates">
              <span><a class="operation-btn" @click="chooseManageOrg(scope.row)">选择</a></span>
            </div>
          </template>
        </el-table-column>
      </el-table>
...
<script>
  ...
  import {queryManageOrg} from 'src/axios/datacenter/authdata/qualitybulletin/qualityBulletin'
  import {keyBoardEnter} from "src/utils";

  export default {
    components: {ElCol},
    name: "commonManageOrg",
    data() {
      return {
        visible: false,
        type: '',
    ...
    methods: {
      ...
      list(){
        queryManageOrg(this.query, this.resData).then(res => {
      ...
      chooseManageOrg(value) {
        this.$emit('chooseManageOrg', {value: value});
        this.visible = false;
      },
