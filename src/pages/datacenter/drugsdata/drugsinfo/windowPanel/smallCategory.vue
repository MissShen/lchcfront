...
<script>
  ...
  import {drugSmallClass} from 'src/axios/datacenter/drugdata/druginfo/druginfo'
  ...
  export default {
    ...
    methods: {
      ...
      metaList() {
        drugSmallClass(this.resData, this.query, this.idBig).then(res => {
