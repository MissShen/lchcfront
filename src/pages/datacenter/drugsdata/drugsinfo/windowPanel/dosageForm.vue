<template>
  <el-dialog
    ...
    <el-form :model="query" ref="query"
          ...
          <el-form-item>
            <el-input v-model="query.searchContent" placeholder="剂型名称" size="small"></el-input>
          </el-form-item>
          <el-form-item>
            <el-input v-model="query.code" placeholder="剂型编码" size="small"></el-input>
          </el-form-item>
          <el-form-item>
...
<script>
  ...
  import {queryDoseageList} from 'src/axios/datacenter/drugdata/druginfo/druginfo'
  ...
  export default {
    ...
    methods: {
      fillData(codeBig, codeSmall, name) {
      ...
      metaList() {
        queryDoseageList(this.resData, this.query, this.codeBig, this.codeSmall, this.name).then(res => {
      ...
      myCallBack(code, id, name) {
        ...
        this.$emit('callBack', code, id, name);
        this.visible = false;
