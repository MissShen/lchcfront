<template>
  <el-dialog
    ...
    <el-form :model="query" ref="query"
          ...
          <el-form-item>
            <el-input v-model="query.value" placeholder="分类名称" size="small"></el-input>
          </el-form-item>
    ...
    <div class="tableset">
      <el-table
        ...
        border
        stripe>
        <el-table-column label="选择复方及小儿标识">
...
<script>
  ...
  import {queryCompound} from 'src/axios/datacenter/drugdata/druginfo/druginfo'
  ...
  export default {
    ...
    methods: {
      ...
      metaList() {
        queryCompound(this.resData, this.query).then(res => {
