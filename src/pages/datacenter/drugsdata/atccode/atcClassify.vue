      ...
      <div class="main">
        ...
        <div class="classify-right">
            <el-form :inline="true" :model="formQuery" ref="formQuery" class="table-form" size="small">
                ...
                <el-form-item>
                  <el-input v-model="formQuery.searchContent" @keyup.enter.native="searchEnterFun" placeholder="关键词" size="small"></el-input>
                </el-form-item>
                <el-form-item>
          ...
          <div class="tree-from" v-show="jsTrableFrom">
            <div class="width-420">
              <el-form :model="resData" ref="resData" :rules="rules" label-position="left" label-width="160px" class="demo-ruleForm" size="small">
                <h3>
                ...
                <el-form-item label="ATC分类编码：" prop="code">
                  <el-input v-model="resData.code" maxlength="20"></el-input>
                </el-form-item>
                <el-form-item label="ATC分类中文名称：" prop="nameChn">
                  <el-input v-model="resData.nameChn" maxlength="80"></el-input>
                </el-form-item>
                <el-form-item label="ATC分类英文名称：" prop="nameEng">
                  <el-input v-model="resData.nameEng" maxlength="120"></el-input>
                </el-form-item>
                <el-form-item label="临时编码：" prop="temporaryCode">
                  <el-select v-model="resData.tempCodeFlag" class="width-260">
                    <el-option
                      v-for="item in formQuery.options1"
                      :key="item.value"
                      :label="item.label"
                      :value="item.value">
                    </el-option>
                ...
                <el-form-item label="描述：" prop="remark">
                  <el-input type="textarea" :rows="4" placeholder="请输入内容" v-model="resData.remark" maxlength="600">
                  </el-input>
                </el-form-item>
...
<script>
  import {catList,catListPage,updateCatAtcCategory,insertCatAtcCategory,findCatAtcCategoryById,deleteCatAtcCategoryByIds} from 'src/axios/datacenter/basedata/catatccategory/catatcegory';
    ...
    data () {
      return {
        ...
        rules:{
          ...
          nameEng:{ required: true, message: '请输入英文名称', trigger: 'blur'},
        }
      }
    },
    methods: {
      ...
      saveInfo(resData){
        this.$refs[resData].validate((valid) => {
          if (valid) {
            if(this.resData.id){
              updateCatAtcCategory(this.resData).then(res => {
                this.$message({
                  message: res.data,
                  type: 'success',
                  duration: 1000,
              ...
              insertCatAtcCategory(this.resData).then(res => {
                this.$message({
                  message: res.data,
                  type: 'success',
                  duration: 1000,
      ...
      deleteById(){
        this.$confirm(`确定删除选中的数据吗?`, '提示', {
          ...
          deleteCatAtcCategoryByIds(this.resData.id).then(res => {
          this.$message({
            message: res.data,
            type: 'success',
            duration: 1000,
      ...
      handleNodeClick(node){
        ...
        this.startVal = '2';
        this.addChild = false;
        findCatAtcCategoryById(node.id).then(res => {
          this.resData = res.data;
      ...
      handleClick(id) {
        this.trees = [];
        findCatAtcCategoryById(id).then(res => {
          this.resData = res.data
          this.listFrom = false;
          this.jsTrableFrom=true;
          this.addChild=false;
