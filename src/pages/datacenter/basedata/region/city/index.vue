    ...
    <div class="tablebox">
        ...
        <el-form ref="query" :model="query" label-position="right" :inline="true" size="small" class="table-form">
            <el-form-item>
              <el-select v-model="query.searchType" placeholder="搜索条件" size="small">
                <el-option label="地市名称" value="1"></el-option>
                <el-option label="地市编码" value="3"></el-option>
                <el-option label="所在省份" value="4"></el-option>
              </el-select>
            </el-form-item>
      ...
      <div class="tableset">
        <el-table
          ...
          <el-table-column sortable="custom" prop="code" label="地市编码" width="200">
          ...
          <el-table-column sortable="custom" prop="name_chn" label="地市名称">
            <template slot-scope="scope">
...
<script>
  ...
  import {cityList, remove} from 'src/axios/datacenter/basedata/region/region'
  ...
  export default {
    ...
    methods: {
      ...
      list () {
        this.$store.state.pageSeach = this.query;
        cityList(this.query, this.resData).then(res => {
      ...
      // 跳转新增页面
      goAdd () {
        this.$router.push("/DATA/basedata/city/add");
      },

      // 跳转详情页面
      goInfo(id) {
        this.$router.push("/DATA/basedata/city/info/"+id);
      },

      // 跳转编辑页面
      goEdit(id) {
        this.$router.push("/DATA/basedata/city/edit/"+id);
      }
