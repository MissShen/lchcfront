      ...
      <div class="width-520">
        <el-form :model="form" ref="form" :rules="rules" label-position="left" label-width="150px" class="demo-ruleForm" size="small">
          ...
          <el-form-item label="计量单位中文名称：" prop="nameChn">
            <el-input v-model="form.nameChn"></el-input>
          </el-form-item>

          <el-form-item label="计量单位英文名称：" prop="nameEng">
            <el-input  v-model="form.nameEng"></el-input >
          </el-form-item>
...
<script>
  import {info} from 'src/axios/datacenter/basedata/metric/metric'
  import {modify} from 'src/axios/datacenter/basedata/metric/metric'
