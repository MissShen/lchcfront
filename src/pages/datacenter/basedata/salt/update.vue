      ...
      <div class="width-520">
        <el-form :model="from" ref="from" :rules="rules" label-position="left" label-width="180px" class="demo-ruleForm" size="small">
          ...
          <el-form-item label="备注：" prop="remark">
            <el-input type="textarea" :rows="2" v-model="from.remark"></el-input>
          </el-form-item>
...
<script>
  ...
  import {modify} from 'src/axios/datacenter/basedata/salt/salt'
