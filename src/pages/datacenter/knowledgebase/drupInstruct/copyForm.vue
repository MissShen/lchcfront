      ...
      <div class="width-600">
        <el-form :model="form" ref="form" :rules="rules" label-position="left" label-width="180px" class="demo-ruleForm"
          ...
          <el-form-item label="通用名称" prop="catDrug.nameChn">
              <el-input v-model="form.catDrug.nameChn" readonly="true" size="small" class="width-380"></el-input>
          ...
          <el-form-item label="关联产品">
                <el-input v-model="form.relateProductNum" readonly="true" size="small" class="width-380"></el-input>
          ...
          <el-form-item label="核准日期">
            <el-date-picker type="date" placeholder="选择日期" format="yyyy-MM-dd" vlue-format="yyyy-MM-dd" v-model="form.catManual.approvalDate"
                            style="width: 100%;"></el-date-picker>
          </el-form-item>
          <el-form-item label="说明书修订日期">
            <el-date-picker type="date" placeholder="选择日期" format="yyyy-MM-dd" vlue-format="yyyy-MM-dd"  v-model="form.manualRevisionDate"
                            style="width: 100%;"></el-date-picker>
          </el-form-item>
          <el-col>
            <el-form-item>
    ...
    methods: {
      metaForm(id){
        ...
        info(id).then(res => {
          this.form = res.data;
          //非复制项内容制空
          this.form.catDrug.nameChn = '';
          this.form.catDrug.nameEng = '';
          this.form.catProduct.tradeName = '';
          this.form.catDrug.spellAbbr = '';
          this.form.catOrg.name = '';
          this.form.relateProductNum = '';
          this.form.catDrug.spec = '';
          this.form.catManual.permitNumber = '';
          //  适应症、功能主治落实
      ...
      chooseProducts(data){
        ...
        for (var i = 0; i < data.value.length; i++) {
          chooseList.push(data.value[i].catProduct.id)
        }
        this.form.ids = chooseList.toString();
        this.form.relateProductNum = chooseList.length;
      }
    }
  }
</script>
