        ...
        <div class="gap-40">
          ...
          <el-form :model="ruleForm" id="right-main-box" :rules="rules" ref="ruleForm" label-width="180px" size="small"
            ...
            <el-row>
              ...
              <el-col :span="12">
                <el-form-item label="单位代码" prop="catOrg.code" readonly="true">
              ...
              <el-col :span="12">
                <el-form-item label="医疗机构类别" prop="catBuyer.buyerKind">
                  <el-select filterable v-model="ruleForm.catBuyer.buyerKind" placeholder="输入关键词搜索"
                             @change="resetCode" class="width-200">
                    <el-option
            ...
            <el-row>
              <el-col :span="12">
                <el-form-item label="所在省/自治区/直辖市" prop="catBuyer.provinceId">
                  <el-select id="123" v-model="ruleForm.catBuyer.provinceId" placeholder="请选择"
...
<script>
  ...
  import {info} from 'src/axios/datacenter/orgdata/catbuyer/catBuyer'
  import {update} from 'src/axios/datacenter/orgdata/catbuyer/catBuyer'
  ...
  export default {
    ...
    created() {
      ...
      info(this.id).then(res => {
        ...
        //记录code初始值
        this.oldCode = this.ruleForm.catOrg.code;
      }).then(
        () => {
          ...
          city(this.ruleForm.catBuyer.provinceId).then(res => {
            this.cityList = res.data;
          });
          county(this.ruleForm.catBuyer.cityId).then(res => {
    ...
    methods: {
      ...
      checkAndShow(){
        if (this.ruleForm.catBuyer.provinceId == "" || this.ruleForm.catBuyer.provinceId == undefined) {
          ...
          this.$nextTick(() => {
            this.$refs.BuyOrgCode//同步隶属关系，医疗机构类别到弹窗,以及省市区ID
      ...
      choose(data) {
        ...
        //发生改变生成新的code
        if (this.code != this.oldCode.substr(0, 9)) {
          ...
          //最终选择等同于不变时，恢复初始值
          this.ruleForm.catOrg.code = this.oldCode;
        }
      },
