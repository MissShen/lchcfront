<template>
  <el-dialog
    :title="!dataForm.id ? '已关联企业列表' : '未关联企业列表'"
    :close-on-click-modal="false"
    width="75%"
    :visible.sync="visible">
    <el-form :model="dataForm" ref="dataForm" label-width="150px" label-position="left" :inline="true" size="small" class="table-form">
        <el-form-item>
    ...
    <div class="tableset">
      ...
      <!--<el-table-->
        ...
        <el-table-column label="企业类型" width="140">
          <template slot-scope="scope">
...
<script>
  ...
  import {queryRelatedOrg} from 'src/axios/datacenter/orgdata/sell/seller'
