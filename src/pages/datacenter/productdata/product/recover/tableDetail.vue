  ...
  <div>
    ...
    <div class="main">
      ...
      <div class="scroll-content">
        <div class="gap-40">
        <el-form :model="from" ref="from" label-position="left" label-width="100px" class="demo-ruleForm"
                 size="small" id="right-main-box">
          ...
          <el-row :gutter="24">
            <el-col :span="12">
              <el-form-item label="审核状态：" prop="name">
                ...
                <a v-if="this.questions.list.length > 0" @click="goQuestionVue">查看质疑</a>
              </el-form-item>
            </el-col>
            <el-col :span="12">
