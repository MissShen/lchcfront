        ...
        <el-table :data="tableData3" stripe>
          ...
          <el-table-column  label="操作">
            <template slot-scope="scope" width="180">
              <el-button @click="handleClick(scope.row)" style="padding:0px;" type="text" size="small">查看产品</el-button>
              <el-button type="text" size="small" style="padding:0px;">查看医院</el-button>
            </template>
          </el-table-column>
        </el-table>
      </div>
