 ...
 * Author:BJCA-zys
 *--------------------------------------------------------------------------*/
export var keyLoginArr = []
// var strServerSignedData = sessionStorage.getItem("strSignedData")
// var strServerRan = sessionStorage.getItem("strRandom")
// var strServerCert = sessionStorage.getItem("strServerCert")
...
export var CERT_OID_NOT_BEFORE = 11;
export var CERT_OID_NOT_AFTER = 12;
...
export function SetUserCertList(strListID, certType) {
...
function $pushAllDropListBox(certUserListObj) {
  // console.info("certUserListObj", certUserListObj)
  keyLoginArr.splice(0, keyLoginArr.length)
  ...
  while (true) {
    ...
    allListArrayTmp.push({label: strName, value: strCertID});
    // console.log('keyLoginArr=', keyLoginArr)
    keyLoginArr = allListArrayTmp
...
function CreateSecXV2Object() {
  ...
  o.GetCertEntity = function (strCert, cb, ctx) {
    var ret = SecXV2.GetCertInfoByOid(strCert, "1.2.86.11.7.1.8");
...
function CreateSecXObject() {
  ...
  o.GetCertEntity = function (strCert, cb, ctx) {
    oCert.importCert(strCert, o.CERT_SRC_BASE64);
    var ret = oCert.getExtCertInfoByOID("1.2.86.11.7.1.8");
...
export function GetSignCert(strCertID, cb, ctx) {
  if ($_$CurrentObj != null) {
...
//verify user pin
export function VerifyUserPIN(strCertID, strUserPIN, cb, ctx) {
  if ($_$CurrentObj != null) {
...
export function GetUserPINRetryCount(strCertID, cb, ctx) {
  if ($_$CurrentObj != null) {
...
// get cert basic info
export function GetCertBasicinfo(strCert, Type, cb, ctx) {
  if ($_$CurrentObj != null) {
...
// get cert entity id
export function GetCertEntity(strCert, cb, ctx) {
  if ($_$CurrentObj != null) {
...
export function GetCertEntityByOid(strCert,oid, cb, ctx) {
  if ($_$CurrentObj != null) {
    return $_$CurrentObj.GetCertInfoByOID(strCert,oid, cb, ctx);
  } else {
    return $myErrorRtnFunc("", cb, ctx);
  }
}
...
//sign data
export function SignedData(strCertID, strInData, cb, ctx) {
  if ($_$CurrentObj != null) {
...
//verify signed data
export function VerifySignedData(strCert, strInData, strSignValue, cb, ctx) {
  if ($_$CurrentObj != null) {
...
export function GetDateNotBefore(strCertValid) {
  if ($_$CurrentObj != null) {
...
export function GetDateNotAfter(strCertValid) {
  if ($_$CurrentObj != null) {
...
function $loginVerifyPINCallBackTest(retObj) {
  var strCertID = retObj.ctx.certID;
  var objForm = retObj.ctx.objForm;
  if (!retObj.retVal) {
    GetUserPINRetryCount(strCertID, $loginGetPINRetryCallBack);
...
export function GetPic(strContainerName, cb, ctx) {
...
export function ConvertPicFormat(strInData, type, cb, ctx) {
